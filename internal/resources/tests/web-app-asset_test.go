			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					append(acctest.ComposeTestCheckResourceAttrsFromMap(assetResourceName, map[string]string{
						...
						"additional_instructions_blocks.1.filename":      "location.json",
						"additional_instructions_blocks.1.filename_type": ".json",
						"additional_instructions_blocks.1.data":          "location data",
						"additional_instructions_blocks.1.type":          "location",
						"additional_instructions_blocks.1.enable":        "false",
						"additional_instructions_blocks.0.filename":      "server.json",
						"additional_instructions_blocks.0.filename_type": ".json",
						"additional_instructions_blocks.0.data":          "server data",
						"additional_instructions_blocks.0.type":          "server",
						"additional_instructions_blocks.0.enable":        "true",
