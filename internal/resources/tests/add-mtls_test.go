			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					append(acctest.ComposeTestCheckResourceAttrsFromMap(assetResourceName, map[string]string{
						...
						"mtls.0.data":             "data:application/x-x509-ca-cert;base64,Y2VydCBkYXRh",
						"mtls.0.type":             "client",
						"mtls.0.enable":           "true",
					}),
						resource.TestCheckResourceAttrSet(assetResourceName, "id"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					append(acctest.ComposeTestCheckResourceAttrsFromMap(assetResourceName, map[string]string{
						...
						"mtls.0.data":             "data:application/x-pem-file;base64,Y2VydCBkYXRh",
						"mtls.0.type":             "client",
						"mtls.0.enable":           "true",
					}),
						resource.TestCheckResourceAttrSet(assetResourceName, "id"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					append(acctest.ComposeTestCheckResourceAttrsFromMap(assetResourceName, map[string]string{
						...
						"mtls.0.certificate_type": ".der",
						"mtls.0.data":             "data:application/x-x509-ca-cert;base64,bmV3IGNlcnQgZGF0YQ==",
						"mtls.0.type":             "server",
						"mtls.0.enable":           "true",
						"mtls.1.filename":         "newfile2.p12",
						"mtls.1.certificate_type": ".p12",
						"mtls.1.data":             "data:application/x-pkcs12;base64,bmV3IGNlcnQgZGF0YTI=",
						"mtls.1.type":             "client",
						"mtls.1.enable":           "false",
					}),
						resource.TestCheckResourceAttrSet(assetResourceName, "id"),
